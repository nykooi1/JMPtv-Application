...
<video id="vVideo" autoplay loop muted><source src="https://jmptv.com/accounts/jjanga/rotated-vid.mp4" type="video/mp4"></source></video>
<div class="vBase"></div>
...
function vStartVideo(){
	...
	//document.getElementById("vVideo").src = "https://jmptv.com/accounts/jjanga/rotated-vid.mp4";
...
if(vSlides.length > 0){
	...
	vTimerHandle = setTimeout(function(){vLooper()}, 58000);
}
