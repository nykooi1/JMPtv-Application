...
<video id="vVideo" autoplay loop muted><source src="https://jmptv.com/accounts/classicrockcoffeelv/classrock.mp4" type="video/mp4"></source></video>
<div class="vBase"></div>
...
if(vSlides.length > 0){
	...
	vTimerHandle = setTimeout(function(){vLooper()}, 38000);
}
